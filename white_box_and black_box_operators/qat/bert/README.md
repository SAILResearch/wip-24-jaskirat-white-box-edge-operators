...
```
# Run
## 1. Enable bert-base-cased/uncased example with the auto QAT operator of Neural Compressor
...
```shell
    bash run_quant.sh --input_model=Intel/bert-base-uncased-mrpc  --output_model=saved_results
```
