...
valdir = os.path.join('/home/21js160/white_box_operations_for_image_models/ILSVRC2012', 'val')
...
torch.onnx.export(
        ...
        'wide-resnet50_distilled_int8_sptq.onnx',  # where to save the model (can be a file or file-like object)
